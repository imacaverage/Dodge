 ...
 * @author iMacAverage
 */
public class WheelsMovesInFigure {
     ...
     */
    public WheelsMovesInFigure(WheelDodge wheelDodge, Figure figure, double impulse, double maxRadius, int countPassive, int countActive, int countActiveLight) {
        WheelMoves wheel;
